...
class MnistDataset():
    def __init__(self, storage_location):
        ...
        self.training_loader = torchvision.datasets.MNIST(storage_location, train=True, download=True,
                                                          transform=torchvision.transforms.Compose(
                                                              [torchvision.transforms.ToTensor(),
                                                               torchvision.transforms.Normalize((0.1307,), (
                                                                   0.3081,))]))
        self.test_loader = torchvision.datasets.MNIST(storage_location, train=False, download=True,
                                                      transform=torchvision.transforms.Compose([
                                                          torchvision.transforms.ToTensor(),
